...
type PublicService interface {
	...
	GetAuthMemberService(session string) (authMemberService AuthMemberService, err error)
...
type AuthMemberService interface {
	...
	RespondSharingRequest(token string, toOrgId string) (toOrg *EmbedOrg, validated *govalidations.Validated, err error)
}
...
type AuthUserService interface {
	...
	GetGroupHeader(groupId string) (headerItem *GroupHeader, err error)
	...
	GetAsideStatus() (asideStatus *AsideStatus, err error)
	...
	//Settings related
	GetOrgSettings(orgId string) (orgSetting *OrgSettings, err error)
	...
	PrepareChangeEmail(newEmail string) (changer *EmailChanger, validated *govalidations.Validated, err error)
