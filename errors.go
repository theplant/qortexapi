...
var SaveUserError = errors.New("can not save user")
...
var SaveEntryError = errors.New("can not save entry")
var UserIsDeletedError = errors.New("user is already deleted")
var SelfActionError = errors.New("can not do this for your self")
var FollowUserError = errors.New("can not follow user")
var UnfollowUserError = errors.New("can not unfollow user")
